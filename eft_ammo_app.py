...
class MyApp(tk.Frame):
    def __init__(self, master=None):
        ...
        self.create_button("All", 0, 1, "nw", 5, (5,10))

        self.create_button("12 Gauge Shot", 1, 0, "nw", 5, 0)
        self.create_button("12 Gauge Slugs", 2, 0, "nw", 5, 0)
        self.create_button("20 Gauge", 3, 0, "nw", 5, (0,10))

        self.create_button("9x18mm", 4, 0, "nw", 5, 0)
        self.create_button("9x19mm", 5, 0, "nw", 5, 0)
        self.create_button("9x21mm", 6, 0, "nw", 5, 0)
        self.create_button("9x39mm", 7, 0, "nw", 5, (0,10))

        self.create_button("0.366", 8, 0, "nw", 5, 0)
        self.create_button("0.388", 9, 0, "nw", 5, 0)
        self.create_button("0.45", 10, 0, "nw", 5, 0)

        self.create_button("4.6x30mm", 1, 2, "nw", 5, 0)

    def create_button(self, text="", row=0, col=0, sticky="nw", padx=5, pady=5, colspan=2):
        self.button = ttk.Button(text=text, width=15)
        self.button.grid(row=row, column=col, sticky=sticky, padx=padx, pady=pady, columnspan=colspan)

if __name__ == "__main__":
    root = tk.Tk()
    root.title("Snackbox (alpha)")
